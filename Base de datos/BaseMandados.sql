...
CREATE TABLE `factura` (
  ...
  KEY `IdEstadoFactura_idx` (`IdEstadoFactura`),
  CONSTRAINT `IdEstadoFactura` FOREIGN KEY (`IdEstadoFactura`) REFERENCES `estadofactura` (`IdEstadoFactura`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `IdEstadoPedido` FOREIGN KEY (`IdEstadoPedido`) REFERENCES `estadopedido` (`IdEstadoPedido`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-17 15:01:35
